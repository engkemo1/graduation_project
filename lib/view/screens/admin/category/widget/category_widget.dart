            ...
            Expanded(
              child: ListView.builder(
                itemBuilder: (context, index) {
                  var category = searchController.text.isEmpty
                      ? cubit.categoryList[index]
                      : cubit.categoryListSearch[index];
                  var date1 = DateTime.parse(category.createdAt.toString());
                ...
                itemCount: searchController.text.isEmpty
                    ...
                    : cubit.categoryListSearch.length,
              ),
            )
          ],
        );
